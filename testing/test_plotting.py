...
class TestPlotting(object):
    ...
    def test_init_9(self):
        ...
        # loc_df
        data = [
            [0, "chr2", 100, False, True, False, "tss", None, None],
    ...
    def test_summary_1(self):
        ...
        # edge_df
        sg.pg.edge_df.drop(
            ["dataset_1", "dataset_2", "curve"], axis=1, inplace=True
        )  # not checking this
        data = [
            [9, "-", "exon", 5, 6, "exon", None],
            [8, "-", "intron", 4, 5, "intron", None],
        ...
        data = [
            [0, "chr2", 100, False, True, False, "tss", "node_outline", 2],
    ...
    def def_summary_2(self):
        ...
        # edge_df
        sg.pg.edge_df.drop(
            ["annotation", "curve"], axis=1, inplace=True
        )  # not checking this
        data = [
            [9, "-", "exon", 5, 6, "exon", None],
            [8, "-", "intron", 4, 5, "intron", None],
    ...
    def test_path_2(self):
        ...
        # loc_df
        sg.pg.loc_df.drop(
            ["dataset_1", "dataset_2"], axis=1, inplace=True
        )  # not checking this
        data = [
            [0, "chr2", 100, False, True, False, "tss", "node_outline", 2],
            [1, "chr2", 80, True, False, False, "internal", "node_outline", 2],
...
def check_dfs(loc_df, ctrl_loc_df, edge_df, ctrl_edge_df):
