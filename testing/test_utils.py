...
class TestUtils(object):
    ...
    def test_reorder_exons_2(self):
        test_exons = ["chr2_100_80_-_exon", "chr2_50_45_-_exon", "chr2_75_60_-_exon"]
        test_exons = swan.reorder_exons(test_exons)
        ctrl_exons = ["chr2_100_80_-_exon", "chr2_75_60_-_exon", "chr2_50_45_-_exon"]
        assert test_exons == ctrl_exons

    # test reorder_exons - fwd
    def test_reorder_exons_1(self):
        test_exons = ["chr1_1_20_+_exon", "chr1_35_40_+_exon", "chr1_25_30_+_exon"]
        test_exons = swan.reorder_exons(test_exons)
        ctrl_exons = ["chr1_1_20_+_exon", "chr1_25_30_+_exon", "chr1_35_40_+_exon"]
    ...
    def test_get_fields(self):
        ...
        ctrl_fields = {
            "gene_id": "test1_gid",
            "gene_name": "test1_gname",
            "transcript_id": "test1",
            "transcript_name": "test1_tname",
