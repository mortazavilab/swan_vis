...
Please visit the [Swan GitHub repository](https://github.com/mortazavilab/swan_vis)
...
Alternatively, the most recent commits can be installed by git cloning [the Swan GitHub repository](https://github.com/fairliereese/swan_vis), moving to the swan\_vis directory, and running
