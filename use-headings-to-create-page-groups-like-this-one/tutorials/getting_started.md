...
First, if you haven't already, make sure to [install Swan](https://github.com/fairliereese/swan_vis/wiki#installation). After installing, you'll be able to run Swan from Python.
...
* [Example data download](getting_started.md#data_download)
* [Starting and initializing your SwanGraph](getting_started.md#init)
* [Add transcript models \(GTF\) and abundance info](getting_started.md#gtf_ab)
* [Saving and loading your SwanGraph](getting_started.md#save_load)
* [Adding transcript models \(GTF\) and abundance info separately](getting_started.md#gtf_ab_sep)
* [Adding transcript models \(TALON db\) and abundance info](getting_started.md#db_ab)
